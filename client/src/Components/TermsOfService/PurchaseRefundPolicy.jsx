  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p className="mb-2">Sebe Inc. provides optional, paid support for UK ETA applications. Our service includes human-reviewed document checks, submission support, and guidance.</p>
