  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p className="mb-2">This website is owned by <span className="font-bold text-black">EETA UK</span>, a Saudi Arabia company based at Kingdom of Saudi Arabia (CR NO.: 2053122409).</p>
